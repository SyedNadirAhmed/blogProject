         ...
         <form action="" method="post" enctype="multipart/form-data">
            <table class="form">
                ...
                <tr>
                    ...
                    <td>
                        <img src="<?php echo $postresult['image'];?>" height="40px" weidht="60px">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="hidden" name="userid" value="<?php echo Session::get('userId');?>" placeholder="Enter Post Author..." class="medium" />
                    </td>
                </tr>
				<tr>
                    <td></td>
